...
// function EventDetailsModal({ isOpen, closeModal, event }) {
...
//   return (
//     <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center overflow-auto modal-overlay" onClick={handleOutsideClick}>
...
//             </div>
//             <div className="flex justify-center mt-3">
//               <Button title={"Update"} type="button" onClick={handleUpdate} />
//             </div>
//             <div>
...
//     try {
//       // const response = await patchAPI('/updateSchedule/:id', updatedEvent);
...
//               />
//             </div>
//             <div className="flex justify-center mt-3" onClick={handleUpdate} >
//               <Button title={"Update"} type="button" />
//             </div>
